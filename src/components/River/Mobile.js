        ...
        <>
            <div class="mobile">
                ...
                <div class="mobile-container">
                    ...
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/p02eP55Dr9Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                </div>
            </div>
        </>
    );
